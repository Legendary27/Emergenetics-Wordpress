...
function login_header( $title = 'Log In', $message = '', $wp_error = '' ) {
	...
	function my_login_logo() { ?>
	    <style type="text/css">
	        .login h1 a {
	            background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/images/Big_Logo.png);
	            padding-bottom: 30px;
	        }
	    </style>
	<?php }
	...
	if ( is_multisite() ) {
		...
		$login_header_url   = __( 'https://www.emergenetics.com/' );
		$login_header_title = __( 'Emergenetics International' );
	}
